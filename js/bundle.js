//This file takes the source code from inputProcess.js and allows the required packages to work
//on the front-end. This is the file that is loaded in to index.html.

//Everything above and below the source code from inputProcess.js is generated with the
//browserify package. It was created with the following call in Command Prompt:

//browserify inputProcess.js -o bundle.js.
...
},{"moment":4,"node-fetch":5,"query-string":6}],2:[function(require,module,exports){
'use strict';
var token = '%[a-f0-9]{2}';
...
},{"decode-uri-component":2,"filter-obj":3,"split-on-first":7,"strict-uri-encode":8}],7:[function(require,module,exports){
'use strict';
